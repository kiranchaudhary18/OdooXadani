...
//   return (
//     <header className="fixed top-0 left-0 right-0 h-16 bg-white border-b border-slate-100 z-40">
//       <div className="h-full px-4 md:px-6 flex items-center justify-between">
//         {/* Logo & Sidebar Toggle */}
//         <div className="flex items-center gap-3">
//           <button
//             onClick={() => setIsSidebarOpen(!isSidebarOpen)}
//             className="hidden md:flex p-2 bg-slate-100 rounded-lg transition-colors text-slate-600"
...
const Navbar = ({ isSidebarOpen, setIsSidebarOpen }) => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 h-16 bg-[#FAFAFA] border-b border-slate-200 z-40">
      <div className="h-full px-4 md:px-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={() => setIsSidebarOpen(!isSidebarOpen)}
            className="hidden md:flex p-2 bg-slate-200 rounded-lg text-slate-700 hover:bg-slate-300 transition-colors"
            title="Toggle Sidebar"
          >
            {isSidebarOpen ? <X size={20} /> : <Menu size={20} />}
          </button>
